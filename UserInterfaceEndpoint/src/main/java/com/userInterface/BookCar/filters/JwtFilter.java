package com.userInterface.BookCar.filters;

import com.userInterface.BookCar.entity.AppUsers;
import com.userInterface.BookCar.entity.user_detail_impl.UserPrinciple;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return path.startsWith("/auth/") || path.equals("/api/sse");
    }
